...
<body>
    ...
    <div class="container">
      ...
      <%= session.getAttribute("USERFIRSTNAME") %></label><br/>
       <label>USERTYPE-
      <%= session.getAttribute("USERTYPE") %></label><br/>
      <b><a href='${pageContext.request.contextPath}/uploadFile' >UploadFile</a></b><br/>
     ...
     <label>Welcome Guest,</label>
      ...
      <br />
        ...
        <table>
            <tr>
                <td colspan="3"><h3>Welcome To WebPortal HomePage</h3></td>
            </tr>
           <tr>
